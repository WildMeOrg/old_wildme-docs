...
9. After the green bounding boxes have appeared, if they represent a matchable Annotation class in Wildbook, you can click **match results** from the menu on the image to view the ongoing or completed matching process. <img src={useBaseUrl('img/quickstart_encounter_startMatch.png')} alt="quickstart_encounter_startMatch" width="33%" height="33%" />
